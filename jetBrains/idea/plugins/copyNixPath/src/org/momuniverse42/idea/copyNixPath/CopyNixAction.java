 ...
 */
public abstract class CopyNixAction extends AnAction {
    ...
    /**
     * Subclasses can adjust the path for final placement to the clipboard.
     */
    @NotNull protected abstract String adjust(@NotNull String path);
